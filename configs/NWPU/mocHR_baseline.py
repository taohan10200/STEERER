...
test = dict(
    ...
    model_file= "/mnt/petrelfs/hantao/HRNet-Semantic-Segmentation/exp/NWPU/MocHRBackbone_hrnet48/mocHR_baseline_2022-09-13-20-28_very_important/Ep_390_mae_74.50794012312964_mse_318.07910123186144.pth",
)
