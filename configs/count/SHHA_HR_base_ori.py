...
test = dict(
    ...
    # For localization
    model_file= './exp/SHHA/MocHRBackbone_hrnet48/SHHA_HR_base_ori_2022-11-18-15-54/Ep_347_mae_55.7664676288982_mse_89.86559351790584.pth'
